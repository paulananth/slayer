...
_DIM_SUFFIXES = (
    ...
    "_year", "_quarter", "_month", "_period", "_week", "_day",
...
_PATTERNS: list[tuple[str, str, str, list[str]]] = [
    ...
    ("_year",         "Year for {stem}.",
                      "What {table} records belong to a given {stem} year?",        []),
    ("_quarter",      "Quarter for {stem}.",
                      "What {table} records belong to a given {stem} quarter?",     []),
    ("_month",        "Month for {stem}.",
                      "What {table} records belong to a given {stem} month?",       []),
    ("_period",       "Period for {stem}.",
                      "What {table} records belong to a given {stem} period?",      []),
    ("_week",         "Week for {stem}.",
                      "What {table} records belong to a given {stem} week?",        []),
    ("_day",          "Day for {stem}.",
                      "What {table} records belong to a given {stem} day?",         []),
